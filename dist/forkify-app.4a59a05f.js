...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); ////// NOTE //////
...
var _resultsViewJs = require("./views/results-view.js");
...
var _addRecipeViewJs = require("./views/add-recipe-view.js");
var _addRecipeViewJsDefault = parcelHelpers.interopDefault(_addRecipeViewJs);
var _configJs = require("./config.js");
var _bookmarkPaginationJs = require("./views/bookmark-pagination.js");
var _bookmarkPaginationJsDefault = parcelHelpers.interopDefault(_bookmarkPaginationJs);
// Hot module reload
// if(module.hot){
//   module.hot.accept();
// }
...
async function controlRecipes() {
    ...
    that happens when a recipe is clicked */ (0, _resultsViewJsDefault.default).update(_modelJs.getSearchResultsPage());
        // Render the bookmarks
        (0, _bookmarksViewJsDefault.default).render(_modelJs.getBookmarksPage(_modelJs.state.bookmarkPaginationNumber));
        // Re-render the pagination buttons
        (0, _bookmarkPaginationJsDefault.default).render(_modelJs.state);
    } catch (err) {
...
const controllSearchResult = async function() {
    try {
        (0, _resultsViewJsDefault.default).loadSpinner(); // Loads the search spinner in the results section
        const query = (0, _searchViewJsDefault.default).getKeyword(); // Get's the searched keyword from the search field
        if (!query) return;
        // making the search 
        await _modelJs.searchRecipeResult(query);
        /* ResultsView.render(Model.state.searchData.results), renders the entire search result in the ui */ (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage()); // this only renders 10 recipes per page
        // Render the initial pagination buttons
        (0, _paginationViewJsDefault.default).render(_modelJs.state.searchData);
    } catch (err) {
        (0, _resultsViewJsDefault.default).renderError(err);
    }
};
/* Function that gets a new array of recipe to be rendered per page.
 eg. 10 recipes per page */ const renderNewRecipeList = function(gotoPage) {
...
const controlAddBookmark = function() {
    // Add the bookmark
    if (!_modelJs.state.recipe.bookmarked) _modelJs.bookmarkRecipe(_modelJs.state.recipe);
    else _modelJs.removeBookmark(_modelJs.state.recipe);
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe); // Update the recipe rendered in UI
    if (_modelJs.state.bookmarks.length > 0) {
        // Render the bookmarks
        (0, _bookmarksViewJsDefault.default).render(_modelJs.getBookmarksPage(_modelJs.state.bookmarkPaginationNumber));
        // Shows arrow buttons on next page or previous page on button click
        (0, _bookmarkPaginationJsDefault.default).render(_modelJs.state);
    } else // insert message if bookmark list is empty
    (0, _bookmarksViewJsDefault.default).bookmarkMessage();
};
// Bookmarks pagination
const controlBookmarkPagination = function(pageNumber) {
    // Render the bookmarks
    (0, _bookmarksViewJsDefault.default).render(_modelJs.getBookmarksPage(pageNumber));
    // Update the bookmark
    (0, _bookmarkPaginationJsDefault.default).render(_modelJs.state);
};
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        }, (0, _configJs.successMessageTimeout) * 1000);
    } catch (error) {
...
const init = ()=>{
    ...
    (0, _bookmarksViewJsDefault.default).renderLocalStorageHandler(controlRenderBookmark);
    // Event listener that  renders the recipe
    (0, _recipeViewJsDefault.default).addRecipeHandler(controlRecipes);
    // This handler increases or decreases the servings
    ...
    (0, _paginationViewJsDefault.default).paginationHandler(renderNewRecipeList);
    // Adds a recipe to the bookmark
    (0, _recipeViewJsDefault.default).addBookmark(controlAddBookmark);
    // Control bookmark per page
    (0, _bookmarkPaginationJsDefault.default).bookmarkPageHandler(controlBookmarkPagination);
    // Add recipe
    (0, _addRecipeViewJsDefault.default).uploadRecipeHandler(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"bzsBv","regenerator-runtime/runtime":"f6ot0","./model.js":"3QBkH","./views/recipe-view.js":"6QNWn","./views/search-view.js":"cBUSJ","./views/results-view.js":"5WaCd","./views/pagination-view.js":"bfmOn","./views/bookmarks-view.js":"93diD","./views/add-recipe-view.js":"1LaMP","./config.js":"2hPh4","./views/bookmark-pagination.js":"9ouQ7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
parcelHelpers.export(exports, "searchRecipeResult", ()=>searchRecipeResult);
...
parcelHelpers.export(exports, "getBookmarksPage", ()=>getBookmarksPage);
parcelHelpers.export(exports, "uploadRecipe", ()=>uploadRecipe);
var _runtime = require("regenerator-runtime/runtime");
var _runtimeDefault = parcelHelpers.interopDefault(_runtime);
var _configJs = require("./config.js");
...
const state = {
    ...
    bookmarksPerPage: (0, _configJs.BOOKMARKS_PER_PAGE)
};
...
const loadRecipe = async function(recipeId) {
    try {
        const getRecipe = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL)}${recipeId}`);
    ...
    rendered in the bookmark section in the UI */ if (state.bookmarks.some((bookmark)=>bookmark.id === recipeId)) state.recipe.bookmarked = true;
        else state.recipe.bookmarked = false;
    } catch (err) {
        throw err;
    }
};
const searchRecipeResult = async function(query) {
    try {
        state.searchData.query = query;
        const getRecipe = await (0, _helpersJs.getJSON)((0, _configJs.RECIPE_URL) + query);
        const data = getRecipe.data?.recipes;
        // check if recipe array is empty
        if (Array.isArray(data) && data.length === 0) throw new Error(`No recipe found for ${query}! Please try another keyword`);
...
const getSearchResultsPage = function(page = state.searchData.pageNumber) {
...
storage and stores it back into the bookmarks array*/ const init = function() {
    const data = localStorage.getItem('bookmarks');
    if (data) state.bookmarks = JSON.parse(data);
};
init();
const getBookmarksPage = function(page = state.bookmarkPaginationNumber) {
...
const uploadRecipe = async function(userRecipe) {
    try {
        ...
        const sentData = await (0, _helpersJs.sendJSON)(`${(0, _configJs.API_URL)}?key=${(0, _configJs.API_KEY)}`, recipe);
...
parcelHelpers.export(exports, "RECIPE_URL", ()=>RECIPE_URL);
parcelHelpers.export(exports, "RESULTS_PER_PAGE", ()=>RESULTS_PER_PAGE);
parcelHelpers.export(exports, "API_KEY", ()=>API_KEY);
parcelHelpers.export(exports, "successMessageTimeout", ()=>successMessageTimeout);
parcelHelpers.export(exports, "BOOKMARKS_PER_PAGE", ()=>BOOKMARKS_PER_PAGE);
const API_URL = 'https://forkify-api.herokuapp.com/api/v2/recipes/';
const TIMEOUT_SECONDS = 10;
const RECIPE_URL = 'https://forkify-api.herokuapp.com/api/v2/recipes/?search=';
const RESULTS_PER_PAGE = 10;
const API_KEY = '0a9d7076-c6bd-454e-834c-8c83c5909e19';
const successMessageTimeout = 3; // This is in seconds. 3 * 1000 in setTimeout function
const BOOKMARKS_PER_PAGE = 4; // Max number of bookmarks on a page 
...
const getJSON = async function(url) {
    try {
        // Loading recipe
        const getRecipe = await Promise.race([
            fetch(url),
...
const sendJSON = async function(url, uploadData) {
    try {
        ...
        const sendRecipe = await Promise.race([
            fetchData,
            timeout((0, _configJs.TIMEOUT_SECONDS))
        ]);
...
},{"./config.js":"2hPh4","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6QNWn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    addRecipeHandler(handler) {
        [
            'hashchange',
            'load'
        ].forEach((evenName)=>window.addEventListener(evenName, handler));
    }
    // Add bookmark
    addBookmark(handler) {
    ...
    <li class="recipe__ingredient">
      ...
      <span class="recipe__quantity">${ing.quantity ? (0, _fractyDefault.default)(ing.quantity) : ''}</span>
...
},{"url:../../img/icons.svg":"fd0vu","fracty":"gsPKI","./view.js":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fd0vu":[function(require,module,exports,__globalThis) {
  ...
  */ // renders the recipe
    ...
    update(data) {
        ...
        newElements.forEach((newEle, i)=>{
            ...
            if (!curElement.isEqualNode(newEle) && newEle.firstChild?.nodeValue.trim() !== '') curElement.textContent = newEle.textContent;
            // Update changed attributes
            if (!curElement.isEqualNode(newEle)) Array.from(newEle.attributes).forEach((attr)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5WaCd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"2kjY2","url:../../img/icons.svg":"fd0vu","./preview-view.js":"kH0tH","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"kH0tH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"2kjY2","url:../../img/icons.svg":"fd0vu","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bfmOn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _recipeMarkup() {
        ...
        if (currentPage === 1 && totalPageNumber > 1) return `
      ...
      <button data-goto="${currentPage + 1}" class="btn--inline pagination__btn--next pagination__btn">
        ...
        if (currentPage === totalPageNumber && totalPageNumber > 1) return `
...
},{"url:../../img/icons.svg":"fd0vu","./view.js":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"93diD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
...
},{"./view.js":"2kjY2","url:../../img/icons.svg":"fd0vu","./preview-view.js":"kH0tH","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1LaMP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class AddRecipeView extends (0, _viewJsDefault.default) {
    ...
    _hideModalHandler() {
        [
            this._closeModalBtn,
            this._overlay
        ].forEach((close)=>close.addEventListener('click', this.toggleWindow.bind(this)));
    }
...
},{"url:../../img/icons.svg":"fd0vu","./view.js":"2kjY2","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9ouQ7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./view.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class BookmarkPagination extends (0, _viewJsDefault.default) {
    ...
    _recipeMarkup() {
        ...
        if (this._data.bookmarkPaginationNumber === 1 && totalBookmarkPage > 1) return `
      <div></div>
      <button class="bookmark__button__arrow js_bookmark_btn_arrow" data-page-number="${this._data.bookmarkPaginationNumber + 1}">
        <span>&rightarrow;</span>
      </button>`;
        if (this._data.bookmarkPaginationNumber === totalBookmarkPage && totalBookmarkPage > 1) return `
        <button class="bookmark__button__arrow js_bookmark_btn_arrow" data-page-number="${this._data.bookmarkPaginationNumber - 1}">
          <span>&LeftArrow;</span>
        </button>
      `;
        if (this._data.bookmarkPaginationNumber < totalBookmarkPage) return `
        <button class="bookmark__button__arrow js_bookmark_btn_arrow" data-page-number="${this._data.bookmarkPaginationNumber - 1}">
          <span>&LeftArrow;</span>
        </button>
        <button class="bookmark__button__arrow js_bookmark_btn_arrow" data-page-number="${this._data.bookmarkPaginationNumber + 1}">
...
exports.default = new BookmarkPagination();
